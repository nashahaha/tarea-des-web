...
const poblarRegiones = () => {
    ...
    data.regiones.forEach(region => {
        ...
        option.value = region.id; // el value queda como el id de la región
        option.text = region.nombre; // el texto visible es el nombre de la región
...
const updateComunas = () => {
    ...
    if (selectedRegion && selectedRegion.comunas) {
        ...
        selectOption.value = "";
        selectOption.text = "Seleccione una comuna";
        comunaSelect.appendChild(selectOption);
        
        selectedRegion.comunas.forEach(comuna => {
            let option = document.createElement("option");
            option.value = comuna.id; // el value queda como el id de la comuna
            option.text = comuna.nombre; // el texto visible es el nombre de la comuna
